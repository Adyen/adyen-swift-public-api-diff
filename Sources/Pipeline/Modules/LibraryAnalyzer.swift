    ...
    private func analyzeProducts(
        ...
        changes += added.compactMap { addition in
            ...
            return .init(
                ...
                parentName: Constants.packageFileName(child: "products")
            )
        }
    ...
    private func analyzeTargets(
        ...
        changes += added.compactMap { addition in
            ...
            return .init(
                ...
                parentName: Constants.packageFileName(child: "targets")
            )
        }
    ...
    private func analyzeDependencies(
        ...
        changes += addedDependencies.compactMap { addition in
            ...
            return .init(
                ...
                parentName: Constants.packageFileName(child: "dependencies")
            )
        }
